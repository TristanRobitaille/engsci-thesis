...
class Master_Ctrl {
    private:
        ...
        const std::map<HIGH_LEVEL_INFERENCE_STEP, broadcast_op_info> broadcast_ops = {
            ...
            {ENC_PRE_MLP_TRANSPOSE_STEP,        {/*op*/ TRANS_BROADCAST_START_OP, /*tx addr*/ NUM_PATCHES+1+EMB_DEPTH,          /*tx len*/ NUM_PATCHES+1,  /*rx addr*/ 4*EMB_DEPTH+NUM_PATCHES+1,      /*num cims*/ NUM_CIM}},
            {ENC_MLP_DENSE_1_STEP,              {/*op*/ DENSE_BROADCAST_START_OP, /*tx addr*/ 4*EMB_DEPTH+NUM_PATCHES+1,        /*tx len*/ EMB_DEPTH,      /*rx addr*/ NUM_PATCHES+1,                  /*num cims*/ NUM_CIM}},
            ...
            {PRE_LAYERNORM_3_TRANS_STEP,        {/*op*/ TRANS_BROADCAST_START_OP, /*tx addr*/ 3*EMB_DEPTH+NUM_PATCHES+2,        /*tx len*/ 1,              /*rx addr*/ 0,                              /*num cims*/ NUM_CIM}},
