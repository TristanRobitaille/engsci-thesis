...
class Master_Ctrl {
    private:
        ...
        const std::map<HIGH_LEVEL_INFERENCE_STEP, broadcast_op_info> broadcast_ops = { //TODO: Double check data_widths
            ...
            {ENC_MHSA_Q_TRANS_STEP,             {/*op*/ TRANS_BROADCAST_START_OP, /*tx addr*/ DOUBLE_WIDTH*(2*(NUM_PATCHES+1)+3*EMB_DEPTH),                     /*tx len*/ NUM_PATCHES+1,   /*rx addr*/ DOUBLE_WIDTH*(NUM_PATCHES+1+EMB_DEPTH),             /*num cims*/ NUM_CIM,           /*data width*/ SINGLE_WIDTH}},
            {ENC_MHSA_K_TRANS_STEP,             {/*op*/ TRANS_BROADCAST_START_OP, /*tx addr*/ DOUBLE_WIDTH*(3*(NUM_PATCHES+1)+3*EMB_DEPTH),                     /*tx len*/ NUM_PATCHES+1,   /*rx addr*/ DOUBLE_WIDTH*(NUM_PATCHES+1+EMB_DEPTH)+EMB_DEPTH,   /*num cims*/ NUM_CIM,           /*data width*/ SINGLE_WIDTH}},
            {ENC_MHSA_QK_T_STEP,                {/*op*/ DENSE_BROADCAST_START_OP, /*tx addr*/ DOUBLE_WIDTH*(NUM_PATCHES+1+EMB_DEPTH),                           /*tx len*/ NUM_HEADS,       /*rx addr*/ DOUBLE_WIDTH*(NUM_PATCHES+1+EMB_DEPTH)+2*EMB_DEPTH, /*num cims*/ NUM_PATCHES+1,     /*data width*/ SINGLE_WIDTH}}, // Will need to call this NUM_HEADS times to go through the Z-stack of the Q and K matrices
            {ENC_MHSA_PRE_SOFTMAX_TRANS_STEP,   {/*op*/ TRANS_BROADCAST_START_OP, /*tx addr*/ DOUBLE_WIDTH*(NUM_PATCHES+1+EMB_DEPTH)+2*EMB_DEPTH+NUM_PATCHES+1, /*tx len*/ NUM_PATCHES+1,   /*rx addr*/ DOUBLE_WIDTH*(NUM_PATCHES+1+EMB_DEPTH),             /*num cims*/ NUM_PATCHES+1,     /*data width*/ SINGLE_WIDTH}}, // Will need to call this NUM_HEADS times to go through the Z-stack of the Q and K matrices
            {ENC_MHSA_V_MULT_STEP,              {/*op*/ DENSE_BROADCAST_START_OP, /*tx addr*/ DOUBLE_WIDTH*(NUM_PATCHES+1+EMB_DEPTH),                           /*tx len*/ NUM_PATCHES+1,   /*rx addr*/ DOUBLE_WIDTH*(NUM_PATCHES+1+EMB_DEPTH)+8*EMB_DEPTH, /*num cims*/ NUM_PATCHES+1,     /*data width*/ SINGLE_WIDTH}}, // Will need to call this NUM_HEADS times to go through the Z-stack of the QK_T matrices
            {ENC_MHSA_POST_V_TRANS_STEP,        {/*op*/ TRANS_BROADCAST_START_OP, /*tx addr*/ DOUBLE_WIDTH*(NUM_PATCHES+1+EMB_DEPTH)+9*EMB_DEPTH,               /*tx len*/ NUM_PATCHES+1,   /*rx addr*/ DOUBLE_WIDTH*(NUM_PATCHES+1),                       /*num cims*/ NUM_CIM,           /*data width*/ SINGLE_WIDTH}},
