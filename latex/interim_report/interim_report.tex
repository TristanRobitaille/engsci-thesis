...
% Gantt chart
    Figure \ref{fig:gantt} plans the future work for this thesis. It is fairly detailed to provide as much guidance as possible.
    \begin{sidewaysfigure}
        ...
        \begin{ganttchart}[hgrid, vgrid, bar label node/.append style={align=right}]{1}{28}
            ...
            \ganttbar{SRAM: Synthesize cell,\\load/read data}{5}{6} \ganttnewline
            \ganttlinkedbar{Multiply and Accumulate\\compute}{7}{8} \ganttnewline
            \ganttlinkedbar{Softmax, LayerNorm\\compute}{9}{10} \ganttnewline
            \ganttlinkedbar{Data packing}{11}{12} \ganttnewline
            \ganttlinkedbar{Control}{13}{14} \ganttnewline
            \ganttlinkedbar{Final simulation}{15}{16} \ganttnewline[thick, black]

            \ganttbar{Pruning}{5}{6} \ganttnewline
            \ganttlinkedbar{AdamW}{7}{8} \ganttnewline
            \ganttlinkedbar{Expanded Sleep-EDF}{9}{10} \ganttnewline
            \ganttlinkedbar{STAGES}{11}{12} \ganttnewline[thick, black]
