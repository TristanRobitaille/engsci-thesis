...
The design uses 64 \ac{cim} to maximize \ac{pe} utilization of the ASIC. Indeed, most weights and intermediate results matrices have at least one dimension that is 61
