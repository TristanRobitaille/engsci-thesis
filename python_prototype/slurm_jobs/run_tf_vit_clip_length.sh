...
#SBATCH --time=00-4:59      # time (DD-HH:MM)
...
--class_weights 1 1 1 0.7 1 \
--input_dataset="/home/tristanr/projects/def-xilinliu/tristanr/engsci-thesis/python_prototype/data/SS3_EDF_Tensorized_both_light_deep_combine-stg_${SLURM_ARRAY_TASK_ID}-0s_256Hz" \
