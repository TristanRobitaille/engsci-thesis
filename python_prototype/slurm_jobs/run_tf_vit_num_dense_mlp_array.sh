...
#SBATCH --time=00-3:59      # time (DD-HH:MM)
#SBATCH --output=%N-%j_num_dense_mlp.out  # %N for node name, %j for jobID
...
--num_heads=8 \
--mlp_dim=32 \
--mlp_head_num_dense=$SLURM_ARRAY_TASK_ID \
...
--note="Number of dense layers in MLP study"
# --output_edgetpu_data \