...
python3 /home/trobitaille/engsci-thesis/python_prototype/edf_extract.py --type=EDF --clip_length_s=30 --num_files=100 \
--enable_multiprocessing --downsampling_freq_hz=256 --sleep_map_name=both_light_deep_combine \
